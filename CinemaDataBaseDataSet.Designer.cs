...
namespace AIS_Kinoteatr {
    ...
    public partial class CinemaDataBaseDataSet : global::System.Data.DataSet {
        ...
        public partial class FilmsDataTable : global::System.Data.TypedTableBase<FilmsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public FilmsRow AddFilmsRow(string Название, string Описание, int Цена, string Режиссёр, string Страна) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public FilmsRow FindByКод(int Код) {
        ...
        public partial class FilmsRow : global::System.Data.DataRow {
            ...
            public int Код {
                get {
                    return ((int)(this[this.tableFilms.КодColumn]));
                }
                set {
...
namespace AIS_Kinoteatr.CinemaDataBaseDataSetTableAdapters {
    ...
    public partial class FilmsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Films` (`Название`, `Описание`, `Цена`, `Режиссёр`, `Страна`) VALUES" +
                " (?, ?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Films` SET `Название` = ?, `Описание` = ?, `Цена` = ?, `Режиссёр` = ?, `Страна` = ? WHERE ((`Код` = ?) AND ((? = 1 AND `Название` IS NULL) OR (`Название` = ?)) AND ((? = 1 AND `Цена` IS NULL) OR (`Цена` = ?)) AND ((? = 1 AND `Режиссёр` IS NULL) OR (`Режиссёр` = ?)) AND ((? = 1 AND `Страна` IS NULL) OR (`Страна` = ?)))";
        ...
        public virtual int Fill(CinemaDataBaseDataSet.FilmsDataTable dataTable) {
        ...
        public virtual CinemaDataBaseDataSet.FilmsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CinemaDataBaseDataSet.FilmsDataTable dataTable = new CinemaDataBaseDataSet.FilmsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CinemaDataBaseDataSet.FilmsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Код, string Original_Название, global::System.Nullable<int> Original_Цена, string Original_Режиссёр, string Original_Страна) {
        ...
        public virtual int Insert(string Название, string Описание, global::System.Nullable<int> Цена, string Режиссёр, string Страна) {
            if ((Название == null)) {
        ...
        public virtual int Update(string Название, string Описание, global::System.Nullable<int> Цена, string Режиссёр, string Страна, int Original_Код, string Original_Название, global::System.Nullable<int> Original_Цена, string Original_Режиссёр, string Original_Страна) {
            if ((Название == null)) {
            ...
            if ((Original_Режиссёр == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((string)(Original_Режиссёр));
            }
            if ((Original_Страна == null)) {
